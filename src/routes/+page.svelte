...
<article>
  ...
  <Quote>
    <strong>Villa Vigo</strong> - voluit leven én<br>comfortabel wonen doe je zo!
  </Quote>
    
  <Content image={HeroImg} imageLeft>
    <svelte:fragment slot="title">Oefen alvast je smile</svelte:fragment>
